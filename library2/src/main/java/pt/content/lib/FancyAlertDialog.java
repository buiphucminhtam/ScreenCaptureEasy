...
public class FancyAlertDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(pt.content.R.layout.dialog_alert, container, false);
    }

    @Override
    public void onDismiss(DialogInterface dialog) {
        super.onDismiss(dialog);
        if (builder != null && builder.getOnDismiss() != null)
            builder.getOnDismiss().onDismiss(dialog);
    }
    ...
    private void initViews(View view) {
        cardView = (CardView) view.findViewById(pt.content.R.id.card_view);
        image = (AppCompatImageView) view.findViewById(pt.content.R.id.image);
        cardView = (CardView) view.findViewById(pt.content.R.id.card_view);
        title = (TextView) view.findViewById(pt.content.R.id.title);
        subTitle = (TextView) view.findViewById(pt.content.R.id.sub_title);
        body = (TextView) view.findViewById(pt.content.R.id.body);
        positive = (Button) view.findViewById(pt.content.R.id.position);
        negative = (Button) view.findViewById(pt.content.R.id.negative);
        buttonsPanel = (LinearLayout) view.findViewById(pt.content.R.id.buttons_panel);
    }
